...
Всё исследование проведено в **образовательных целях**. Данные получены из публично доступного APK методами статического анализа. Никакие production-системы не затрагивались. Найденные проблемы были переданы Glovo до публичного раскрытия и исправлены к 2 апреля 2026 года.
